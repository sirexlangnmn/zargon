...
jQuery(document).ready(function() {
	...
	var orange = true;
		...
		$('#orange-css').on('click', function () {
			...
			document.getElementById('download-bitcoin').src='images/project-coins/icons/download-bitcoin.png';
			document.getElementById('add-bitcoin').src='images/project-coins/icons/add-bitcoin.png';
			document.getElementById('buy-sell-bitcoin').src='images/project-coins/icons/buy-sell-bitcoin.png';
			document.getElementById('strong-security').src='images/project-coins/icons/strong-security.png';
			document.getElementById('world-coverage').src='images/project-coins/icons/world-coverage.png';
			document.getElementById('payment-options').src='images/project-coins/icons/payment-options.png';
			document.getElementById('mobile-app').src='images/project-coins/icons/mobile-app.png';
			document.getElementById('cost-efficiency').src='images/project-coins/icons/cost-efficiency.png';
			document.getElementById('high-liquidity').src='images/project-coins/icons/high-liquidity.png';
		});
		...
		$('#green-css').on('click', function () {
			...
			document.getElementById('add-bitcoin').src='images/icons/green/add-bitcoin.png';
			document.getElementById('buy-sell-bitcoin').src='images/icons/green/buy-sell-bitcoin.png';
		...
		$('#blue-css').on('click', function () {
			...
			document.getElementById('add-bitcoin').src='images/icons/blue/add-bitcoin.png';
			document.getElementById('buy-sell-bitcoin').src='images/icons/blue/buy-sell-bitcoin.png';
